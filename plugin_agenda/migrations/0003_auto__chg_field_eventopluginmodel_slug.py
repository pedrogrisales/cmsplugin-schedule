...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventoPluginModel.slug'
        db.alter_column('plugin_agenda_eventopluginmodel', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'EventoPluginModel.slug'
        db.alter_column('plugin_agenda_eventopluginmodel', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

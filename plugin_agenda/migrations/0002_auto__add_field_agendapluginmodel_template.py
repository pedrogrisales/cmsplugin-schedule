...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgendaPluginModel.template'
        db.add_column('cmsplugin_agendapluginmodel', 'template',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgendaPluginModel.template'
        db.delete_column('cmsplugin_agendapluginmodel', 'template')

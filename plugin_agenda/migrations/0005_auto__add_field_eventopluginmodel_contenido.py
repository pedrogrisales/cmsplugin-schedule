...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventoPluginModel.contenido'
        db.add_column('plugin_agenda_eventopluginmodel', 'contenido',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventoPluginModel.contenido'
        db.delete_column('plugin_agenda_eventopluginmodel', 'contenido_id')

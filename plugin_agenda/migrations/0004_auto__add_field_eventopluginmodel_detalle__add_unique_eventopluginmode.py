...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventoPluginModel.detalle'
        db.add_column('plugin_agenda_eventopluginmodel', 'detalle',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'EventoPluginModel', fields ['slug']
        db.create_unique('plugin_agenda_eventopluginmodel', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventoPluginModel', fields ['slug']
        db.delete_unique('plugin_agenda_eventopluginmodel', ['slug'])

        # Deleting field 'EventoPluginModel.detalle'
        db.delete_column('plugin_agenda_eventopluginmodel', 'detalle')
